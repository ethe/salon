...
This file is for AI agents contributing to this repository. For product overview, architecture, workflow, and user-facing usage, see `README.md`.
...
- Run `npm test` after changes to hooks, guest lifecycle logic, discussion flow, resume behavior, or worktree handling.
